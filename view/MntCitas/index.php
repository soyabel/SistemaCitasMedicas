...
>
  ...
  <body>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                <div class="row">
                  ...
                  <button type="button" id="btnnuevo" class="btn btn-secondary-link fw-bold">Nueva Cita</button>
                  </div>
                </div>                 
    ...
    <!-- Core JS -->
    <?php require_once("modalmantenimientoeditar.php");?>
    <?php require_once("modalmantenimiento.php");?>
    <?php require_once("../MainJs/js.php") ?>
    <script type="text/javascript" src="mntcitas.js"></script>
  </body>
</html>
<?php
}else{
