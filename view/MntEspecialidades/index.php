...
>
  ...
  <body>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                <div class="row">                 
                  <div class="col-6">
                       <h5 class="card-header">Especialedades</h5>
                  </div>
                  <div class="col-6 d-flex justify-content-end align-content-center ">
                        <button type="button" id="btnnuevo" class="btn btn-secondary-link fw-bold">Nueva Especialidad</button>
                  </div>
                </div>   
    ...
    <script type="text/javascript" src="mntespecialidades.js"></script>
  </body>
</html>
<?php
}else{
